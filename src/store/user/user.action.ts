...
export type SetCurrentSession = ActionWithPayload<USER_ACTION_TYPES.SET_CURRENT_USER, UserData>;
...
export const setCurrentUser = withMatcher((user: UserData): SetCurrentSession =>
